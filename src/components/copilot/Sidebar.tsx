...
const HELPDESK_WHATSAPP_URL =
  "https://wa.me/628111500587?text=Halo%20Helpdesk%20SIMKOPDES%20%F0%9F%91%8B%0ASaya%20ingin%20melaporkan%20kendala%20dengan%20detail%20berikut%3A%0ANama%3A%20%0AEmail%3A%20%0ANama%20Koperasi%20%3A%20%0AKendala%3A%20%0ABukti%20(Foto%2FVideo)%3A%20%0A%0ATerima%20kasih";
      ...
      <header className="shrink-0 bg-emerald-700 px-4 py-3 text-white shadow-sm">
        <div className={`mx-auto flex items-center gap-3 ${embedded ? "w-full" : "max-w-2xl"}`}>
          ...
          <a
            ...
            aria-label="Bantuan WhatsApp Helpdesk SIMKOPDES"
